...
public class R__gestao_de_recursos_humanos extends IgrpMigrationTemplate{
	...
	public void reports() {
		...
		RepTemplate report0 = new RepTemplate("dec_venc", "Declaração de Vencimento", Core.ToDateUtil("2023-03-06", "yyyy-MM-dd"), Core.ToDateUtil("2023-03-06", "yyyy-MM-dd"),1, userCreated0, userUpdated0, env0,  new CLob("null" ,"null", null, Core.ToDateUtil("2023-03-06", "yyyy-MM-dd"), env0, "null"), new CLob("null" ,"null", null, Core.ToDateUtil("2023-03-06", "yyyy-MM-dd"), env0, "null"), "4930bdb3-a663-4c69-954c-4cc399b8e292");
