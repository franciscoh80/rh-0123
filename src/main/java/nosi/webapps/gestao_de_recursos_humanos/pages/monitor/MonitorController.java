...
import nosi.webapps.gestao_de_recursos_humanos.pages.monitor.Monitor.Chart_1; //block import
import java.util.Map; //block import
import java.util.ArrayList; //block import
import java.util.List; //block import
import java.util.stream.Collectors; //block import
import java.util.LongSummaryStatistics; //block import
import nosi.webapps.gestao_de_recursos_humanos.pages.monitor.Monitor.Chart_2; //block import
import java.util.Map; //block import
import java.util.List; //block import
import java.util.stream.Collectors; //block import
import java.util.LongSummaryStatistics; //block import
...
public class MonitorController extends Controller {
	public Response actionIndex() throws IOException, IllegalArgumentException, IllegalAccessException{
		...
		model.load();
		model.setStatbox_1_title("Total de Funcionarios");
		model.setStatbox_1_val("194");
	...
	if(Core.isNotNull(value)){
		model.setStatbox_1_val(String.valueOf(value));
			model.setStatbox_1_url(Core.getIGRPLink("gestao_de_recursos_humanos", "Lista_de_funcionarios", "index"));
	}
	}catch ( Exception e ) {
		e.printStackTrace();
	}
