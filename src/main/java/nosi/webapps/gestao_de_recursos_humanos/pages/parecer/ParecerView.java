...
public class ParecerView extends View {
	...
	public IGRPButton btn_registar_parecer;

	public ParecerView(){

		this.setPageTitle("Parecer");
		...
		parecer.propertie().add("name","p_parecer").add("type","select").add("multiple","false").add("tags","false").add("load_service_data","false").add("domain","PARECER « gestao_de_recursos_humanos").add("maxlength","250").add("required","true").add("disabled","false").add("java-type","").add("tooltip","false").add("disable_copy_paste","false");
		
		obs_parcer = new TextAreaField(model,"obs_parcer");
		obs_parcer.setLabel(gt("Observação"));
		obs_parcer.propertie().add("name","p_obs_parcer").add("type","textarea").add("maxlength","4000").add("required","false").add("readonly","false").add("disabled","false").add("disablehtml","true").add("placeholder",gt("")).add("desclabel","false").add("tooltip","false").add("disable_copy_paste","false");
		...
		btn_registar_parecer = new IGRPButton("Registar Parecer","gestao_de_recursos_humanos","Parecer","registar_parecer","submit","primary|fa-save","","");
		btn_registar_parecer.propertie.add("type","specific").add("rel","registar_parecer").add("refresh_components","");
	...
	public void render(){
		...
		toolsbar_1.addButton(btn_registar_parecer);
